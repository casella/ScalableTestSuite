...
package HeatConduction
  ...
  model OneDHeatTransferTT_Modelica_N_20480
    extends  OneDHeatTransferTT_Modelica_N_1280(N = 20480);
    annotation(experiment(StopTime = 350, Tolerance = 1e-4),
               __OpenModelica_simulationFlags(s = "ida"));
  end OneDHeatTransferTT_Modelica_N_20480;

  model OneDHeatTransferTT_Modelica_N_40960
    extends  OneDHeatTransferTT_Modelica_N_1280(N = 40960);
    annotation(experiment(StopTime = 350, Tolerance = 1e-4),
               __OpenModelica_simulationFlags(s = "ida"));
  end OneDHeatTransferTT_Modelica_N_40960;

  model OneDHeatTransferTT_Modelica_N_81920
    extends  OneDHeatTransferTT_Modelica_N_1280(N = 81920);
    annotation(experiment(StopTime = 350, Tolerance = 1e-4),
               __OpenModelica_simulationFlags(s = "ida"));
  end OneDHeatTransferTT_Modelica_N_81920;

  model OneDHeatTransferTT_Modelica_N_163840
    extends  OneDHeatTransferTT_Modelica_N_1280(N = 163840);
    annotation(experiment(StopTime = 350, Tolerance = 1e-4),
               __OpenModelica_simulationFlags(s = "ida"));
  end OneDHeatTransferTT_Modelica_N_163840;

  model OneDHeatTransferTT_Modelica_N_327680
    extends  OneDHeatTransferTT_Modelica_N_1280(N = 327680);
    annotation(experiment(StopTime = 350, Tolerance = 1e-4),
               __OpenModelica_simulationFlags(s = "ida"));
  ...
  model OneDHeatTransferTI_Modelica_N_20480
    extends  OneDHeatTransferTI_Modelica_N_1280(N = 20480);
    annotation(experiment(StopTime = 350, Tolerance = 1e-4),
               __OpenModelica_simulationFlags(s = "ida"));
  end OneDHeatTransferTI_Modelica_N_20480;

  model OneDHeatTransferTI_Modelica_N_40960
    extends  OneDHeatTransferTI_Modelica_N_1280(N = 40960);
    annotation(experiment(StopTime = 350, Tolerance = 1e-4),
               __OpenModelica_simulationFlags(s = "ida"));
  end OneDHeatTransferTI_Modelica_N_40960;

  model OneDHeatTransferTI_Modelica_N_81920
    extends  OneDHeatTransferTI_Modelica_N_1280(N = 81920);
    annotation(experiment(StopTime = 350, Tolerance = 1e-4),
               __OpenModelica_simulationFlags(s = "ida"));
  end OneDHeatTransferTI_Modelica_N_81920;

  model OneDHeatTransferTI_Modelica_N_163840
    extends  OneDHeatTransferTI_Modelica_N_1280(N = 163840);
    annotation(experiment(StopTime = 350, Tolerance = 1e-4),
               __OpenModelica_simulationFlags(s = "ida"));
  end OneDHeatTransferTI_Modelica_N_163840;

  model OneDHeatTransferTI_Modelica_N_327680
    extends  OneDHeatTransferTI_Modelica_N_1280(N = 327680);
    annotation(experiment(StopTime = 350, Tolerance = 1e-4),
               __OpenModelica_simulationFlags(s = "ida"));
